...
#this script prioritizes time, and takes a picture based on data held in memory.
import time
import serial
import piexif
...
while 1:
    ...
    if end - start > 5 and quality == 1:
        print(end - start)
        #taking picture
        imageName = 'Periodic-AttitudeTaggedImages//image' + str(count) + 'lat=' + roll + 'long=' + pitch + '.jpg'
